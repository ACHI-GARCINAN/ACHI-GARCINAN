...
class SectionBlock(QFrame):
    ...
    def __init__(self, section: dict, main_witness: str,
                 font_family: str = 'David', font_size: int = 16, theme: str = 'classic', continuous_view: bool = False, parent=None):
        ...
        self._continuous_view = continuous_view
        ...
        self.tag.setVisible(not self._continuous_view)
